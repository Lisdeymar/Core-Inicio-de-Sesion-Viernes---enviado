...
class MySQLConnection:
    ...
    # el método para consultar la base de datos, para ejecutar queries, dentro del parametro tiene query, es decir va a recibir query, dinde dice datta va a recibir datos, porque hay quries que le enviamos data por ejemplo cuando ponemos where
